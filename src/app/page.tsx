...
const contractAddress = "0x9B37654fc8d92cfdd3CF7bc8b507aefc34E795E0"; // fantom testnet

// "0xA4CCEb9e84b9682ca559AA41DB57f4BECe586dc5" // fantom testnet
// "5ireChain" // 0x1a8784a45731F889D4a92258AE7E149d5C737AA1
// "Mantle" 0x9B37654fc8d92cfdd3CF7bc8b507aefc34E795E0
...
export default function Home() {
  ...
  const handleSendTransaction = async () => {
    ...
    await writeAsync?.().then((res) => {
      ...
      // mantle = https://explorer.testnet.mantle.xyz/tx/${res.hash}
    });
