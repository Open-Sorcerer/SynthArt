...
const HamsterLoader = (props: any) => {
    ...
    return (
        <div aria-label='Orange and tan hamster running in a metal wheel' role='img' className={`${styles.wheel_and_hamster} rounded-full bg-black/70 p-6`}>
            <h1 className='text-lg font-bold'>{loaderTitle}</h1>
